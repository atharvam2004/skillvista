  ...
  <div>
    <div className="footer">
      <div className="footer-content">
        <div className="footer-div1" id="footer-divs">
          <img alt="logofooter" id="logo-navbar1 " src={logo} />
        </div>
        <div className="footer-div2" id="footer-divs">
          <h5>Information</h5>
          <br />
          <Link id="footer-contactus" to={"/about"}>
            About Us
          </Link>
          <Link id="footer-contactus" to={"/Privacy"}>
            Privacy Policy
          </Link>
        </div>
        <div className="footer-div3" id="footer-divs">
          <h5>Legal</h5>
          <br />
          <Link id="footer-contactus" to={"/terms"}>
            Terms & Conditions
          </Link>
        ...
        <div className="footer-div4" id="footer-divs">
          <h5>Help</h5>
          <br />
          <Link id="footer-contactus" to={"/contactus"}>
            Contact Us
          </Link>
        </div>
          ...
          <div className="contact-links2  ">
            ...
            <a href="https://www.instagram.com/_atharva.meher_/?hl=en">
              <svg
                ...
                viewBox="0 0 16 16"
                id="contact-icon"
                target="https://www.instagram.com/_atharva.meher_/"
              >
            ...
            <a href="mailto:contact@skillvista.co.in" id="footer-contactus">
